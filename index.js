...
global.whatsappChannelLink = "https://whatsapp.com/channel/0029Vb77pP4A89Mje20udJ32";
...
You have been granted an audience with *QUEEN EMILY MD*!
...
📢 *WhatsApp Group:* https://chat.whatsapp.com/JmKpvUD4b2yBggTq615uO2?mode=ac_t
📡 *Telegram Channel:* https://t.me/+RyHOondjwZdkZDY0
🎥 *YouTube Channel:* https://youtube.com/@cotech-1?si=XGEDdFrQOm3QaZpq
`;
    ...
    const buttons = [
        ...
        },
        {
            urlButton: {
                ...
                url: "https://chat.whatsapp.com/JmKpvUD4b2yBggTq615uO2?mode=ac_t"
            }
        },
        {
            urlButton: {
        ...
        },
        {
            urlButton: {
                displayText: "🎥 YouTube",
                url: "https://youtube.com/@cotech-1?si=XGEDdFrQOm3QaZpq"
            }
        },
        {
            quickReplyButton: {
    ...
    return {
        text: royalBanner,
        footer: "Long live QUEEN EMILY! May your journey be prosperous!",
...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            console.log(chalk.yellow(`👑 QUEEN EMILY MD Connected to => ` + JSON.stringify(XeonBotInc.user, null, 2)))
            ...
            try {
                ...
                await XeonBotInc.sendMessage(botNumber, {
                    text: `📢 *Royal Announcement*\n\n` +
                          ...
                          `YouTube: https://youtube.com/@cotech-1?si=XGEDdFrQOm3QaZpq`,
                    templateButtons: [{
                        index: 1, 
                        urlButton: {
                            displayText: '👑 Join Royal Channel',
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'QUEEN EMILY MD 👑'} ]`)}\n\n`))
            ...
            console.log(chalk.green(`${global.themeemoji || '👑'} QUEEN EMILY MD has ascended the throne successfully! 👑`))
